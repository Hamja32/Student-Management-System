...
<body>
    ...
    <div class="nav-links">
        <a href="<%=request.getContextPath()%>/list">← Back to Student List</a>
    </div>
    ...
    <div class="form-card">
        ...
        <form action="<%=request.getContextPath()%>/insert" method="post" onsubmit="return handleFormSubmit()">
            
            <div class="form-group">
                <label>Roll Number</label>
                <input type="text" name="roll_no" placeholder="e.g. 101" required/>
            </div>
