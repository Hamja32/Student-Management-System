	...
	<div class="nav-bar"
		...
		<div>
			<a href="<%=request.getContextPath()%>/list" class="btn-nav">Refresh
				...
				class="btn-nav btn-add">+ Add Student</a> <a href="<%=request.getContextPath()%>/attendance" class="btn-nav">Mark Attendance 📅</a><a href="<%=request.getContextPath() %>/view-attendance" class="btn-nav btn-add">View Reports 📊</a><a href="login"
