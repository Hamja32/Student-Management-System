...
/* --- PRINT WALI CSS --- */
@media print {
    /* 1. Buttons aur Links ko chhupao */
    .nav-links, button, a, .no-print {
        display: none !important;
    }

    /* 2. Login info chhupao */
    div[style*="position: absolute"] {
        display: none !important;
    }

    /* 3. Card ka shadow hatao aur full width karo */
    .sheet-card {
        box-shadow: none;
	...
	<div
		...
		<div class="sheet-card">
			...
			<div style="text-align: center; margin-bottom: 20px;">
				<img src="<%=info.getPhotoName() %>" width="80" height="80"
					style="border-radius: 50%; object-fit: cover;" alt="Student Photo"
			...
			<br>
			<div align="center">
				<button onclick="window.print()">Print/Download Marksheet</button>
			</div>
